...
void LevelParser::parseTextures(TiXmlElement* pTextureRoot)
{
    ...
    TheTextureManager::getInstance()->load(pTextureRoot->Attribute("value"), pTextureRoot->Attribute("name"), TheGame::getInstance()->getRenderer());
}
...
void LevelParser::parseTilesets(TiXmlElement* pTilesetRoot, std::vector<Tileset>* pTilesets)
{
    ...
    TheTextureManager::getInstance()->load(assetsTag.append(pTilesetRoot->FirstChildElement()->Attribute("source")), pTilesetRoot->Attribute("name"), TheGame::getInstance()->getRenderer());
